...
extension UIView {
    ...
    /// This function creates view with gradient.

    func applyGradient(withColours colours: [CGColor], gradientOrientation orientation: GradientOrientation, width: CGFloat, height: CGFloat, corner: CGFloat) {
